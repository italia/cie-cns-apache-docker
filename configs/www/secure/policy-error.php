    ...
    <div class="section-content">
      ...
      <div class="container white-color">
        <div class="callout callout-highlight danger">
          ...
          <p>Non è stato possibile autenticarti. Errore Certificate Policies (Object ID: 2.5.29.32) :-(</p>
          <p>Il certificato presentato è valido ma non rispetta le&nbsp;<strong>Certificate Policies (Object ID: 2.5.29.32)</strong> previste per la CIE e TS-CNS.</p>

          <div class="link-list-wrapper">
            <ul class="link-list">
              <li><a class="list-item active icon-right" href="http://oid-info.com/cgi-bin/display?oid=1.3.76.16.2.1&action=display">
                  <svg class="icon icon-primary">
                    <use xlink:href="/bootstrap-italia/svg/sprite.svg#it-link"></use>
                  </svg>
                  <span>OID 1.3.76.16.2.1 per la CNS</span>
                </a></li>
              <li><a class="list-item active icon-right" href="http://oid-info.com/get/1.3.76.47">
                  <svg class="icon icon-primary">
                    <use xlink:href="/bootstrap-italia/svg/sprite.svg#it-link"></use>
                  </svg>
                  <span>OID 1.3.76.47.4 per la CIE</span>
                </a></li>
            </ul>
          </div>
          ...
          <div class="it-btn-container">
            ...
            <a class="btn btn-secondary" href="/secure/">Riprova ad accedere</a>
          </div>
