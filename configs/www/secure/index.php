...
<body>
                            ...
                            <div class="header-slim-right-zone">
                                <div class="it-access-top-wrapper">
                                    <a class="btn btn-primary bg-primary btn-icon btn-full" role="button" href="/secure/">
                                        ...
                                        <span><?= getenv('SSL_CLIENT_S_DN_G') ?> <?= getenv('SSL_CLIENT_S_DN_S') ?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="section">
        <div class="section-content">
            ...
            <div id="itButtonContainer" class="container white-color">
                <div class="callout callout-highlight success">
                    ...
                    <dl class="row text-black">
                        ...
                        <dd class="col-sm-9"><?= substr(getenv('SSL_CLIENT_S_DN_CN'), 0, 16) ?></dd>

                        <dt class="col-sm-3">CNS/CIE Rilasciata</dt>
                        <dd class="col-sm-9"><?= getenv('SSL_CLIENT_I_DN_CN') ?></dd>

                        <dt class="col-sm-3">Certificato Rilasciato</dt>
                        <dd class="col-sm-9"><?= getenv('SSL_CLIENT_I_DN_O') ?></dd>

                        <dt class="col-sm-3">Verifica Certificato</dt>
                        <dd class="col-sm-9"><?= getenv('SSL_CLIENT_VERIFY') ?></dd>

                        <dt class="col-sm-3">Validità Certificato</dt>
                        <dd class="col-sm-9"><?= getenv('SSL_CLIENT_V_START') ?> al <?= getenv('SSL_CLIENT_V_END') ?></dd>
                    </dl>

                    <div class="it-btn-container">
                        <button type="button" class="btn btn-success" data-toggle="collapse" data-target="#collapseCertificate" aria-expanded="false" aria-controls="collapseCertificate">
                            Vedi Certificato Strutturato
                        </button>
                        <button type="button" class="btn btn-success" data-toggle="collapse" data-target="#collapseCertificatePem" aria-expanded="false" aria-controls="collapseCertificatePem">
                            Vedi Certificato PEM (x509 Base64)
                        </button>

                        <div class="collapse" id="collapseCertificate" data-parent="#itButtonContainer">
                        ...
                        <div class="collapse" id="collapseCertificatePem" data-parent="#itButtonContainer">
                            <div class="card card-body text-black">
                                <pre>
