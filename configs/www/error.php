    ...
    <div class="section-content">
      ...
      <div class="container white-color">
        <div class="callout callout-highlight danger">
          ...
          <p>Non è stato possibile autenticarti :-(</p>
          <p>Verifica che il lettore sia correttamente collegato e funzionante, e che la carta
            CIE o TS-CNS sia correttamente inserita o appoggiata sul lettore nel momento in cui
            si procede con l'accesso.</p>
