    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-toggleable-sm">
            ...
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="<?= getenv('APPLICATION_URL') ?>">
                         <img src="../assets/images/iconfinder-21-3319623-1-174x174.png" alt="CIE/TS-CNS" title="" style="height: 5.6rem;">
                    </a>
                </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn">
                <a class="btn btn-sm btn-primary display-4" href="<?= getenv('APPLICATION_URL') ?>/secure"><span class="mobi-mbri mobi-mbri-login mbr-iconfont mbr-iconfont-btn"></span>
                    Accedi
                </a>
            </div>
        </div>
        ...
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">
                    Si sono verificati errori<br></h1>
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2">Non è stato possibile autenticarti :-(&nbsp;</h3>
                <p class="mbr-text pb-3 mbr-fonts-style display-7">Verifica che il lettore sia correttamente collegato e funzionante, e che la carta CIE o TS-CNS sia correttamente inserita o appoggiata sul lettore nel momento in cui si procede con l'accesso.&nbsp;<br><br></p>
                <div class="mbr-section-btn"><a class="btn btn-md btn-primary display-4" href="https://github.com/italia/cie-cns-apache-docker">VAI AL PROGETTO</a>
                    <a class="btn btn-md btn-black display-4" href="<?= getenv('APPLICATION_URL') ?>/secure">ACCEDI CON LA TUA CIE o CNS</a></div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-md-3">
                <div class="media-wrap">
                    <a href="https://mobirise.com/">
                        <img src="../assets/images/iconfinder-21-3319623-1-174x174.png" alt="CIE/TS-CNS" title="">
                    </a>
                </div>
            </div>
